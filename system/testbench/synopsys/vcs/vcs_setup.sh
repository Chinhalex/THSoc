...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/red_leds.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/pwm_wrapper.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/count.v \
